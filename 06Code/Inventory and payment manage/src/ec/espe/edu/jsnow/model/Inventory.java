...
public class Inventory {
    ...
    public static void generateProductOutputReport(String name, String price, String pathToFileReport) {
        Scanner scanner;
    ...
    public static void registerProductOutput(String id, String pathToFile) throws FileNotFoundException, IOException {
        DateTimeFormatter dateTime;
        Scanner scanner;
        String temporalFile;
        String line;
