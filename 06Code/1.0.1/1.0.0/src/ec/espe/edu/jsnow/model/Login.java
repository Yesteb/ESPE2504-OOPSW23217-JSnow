...
public class Login {
    ...
    public static void adminLogin() {
        ...
        while (count < 3) {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader("src/resources/adminCredentials.txt"))) {
                String lineReader;
                accessAdmin = false;
    ...
    public static void employeLogin(){
        ...
        while (count < 3) {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader("src/resources/employeCredentials.txt"))) {
                String lineReader;
                accessEmploye = false;
